...
public class TlsHelper {
      ...
      if (TlsSystemConfig.tlsTestModeEnable) {
        ...
        return sslContextBuilder
            .keyManager(
                ...
                !isNullOrEmpty(TlsSystemConfig.tlsClientKeyPath)
                    ? decryptionStrategy.decryptPrivateKey(TlsSystemConfig.tlsClientKeyPath, true)
                    : null,
      ...
      if (TlsSystemConfig.tlsTestModeEnable) {
        ...
        SslContextBuilder sslContextBuilder =
            SslContextBuilder.forServer(
                    !isNullOrEmpty(TlsSystemConfig.tlsServerCertPath)
                        ? new FileInputStream(TlsSystemConfig.tlsServerCertPath)
                        : null,
                    !isNullOrEmpty(TlsSystemConfig.tlsServerKeyPath)
                        ? decryptionStrategy.decryptPrivateKey(TlsSystemConfig.tlsServerKeyPath, false)
                        : null,
  ...
  private static void extractTlsConfigFromFile(final File configFile) {
    ...
    TlsSystemConfig.tlsTestModeEnable =
        Boolean.parseBoolean(
            properties.getProperty(TlsSystemConfig.TLS_TEST_MODE_ENABLE, String.valueOf(TlsSystemConfig.tlsTestModeEnable)));
    TlsSystemConfig.tlsServerNeedClientAuth =
        properties.getProperty(TlsSystemConfig.TLS_SERVER_NEED_CLIENT_AUTH, TlsSystemConfig.tlsServerNeedClientAuth);
    ...
    TlsSystemConfig.tlsServerAuthClient =
        Boolean.parseBoolean(
            properties.getProperty(TlsSystemConfig.TLS_SERVER_AUTHCLIENT, String.valueOf(TlsSystemConfig.tlsServerAuthClient)));
    TlsSystemConfig.tlsServerTrustCertPath =
        properties.getProperty(TlsSystemConfig.TLS_SERVER_TRUSTCERTPATH, TlsSystemConfig.tlsServerTrustCertPath);
    ...
    TlsSystemConfig.tlsClientAuthServer =
        Boolean.parseBoolean(
            properties.getProperty(TlsSystemConfig.TLS_CLIENT_AUTHSERVER, String.valueOf(TlsSystemConfig.tlsClientAuthServer)));
    TlsSystemConfig.tlsClientTrustCertPath =
        properties.getProperty(TlsSystemConfig.TLS_CLIENT_TRUSTCERTPATH, TlsSystemConfig.tlsClientTrustCertPath);
  }
